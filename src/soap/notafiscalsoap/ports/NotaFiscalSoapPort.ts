...
export interface NotaFiscalSoapPort {
  ConsultarNfsePorRps(
    ...
    callback: (
      err: any,
      result: TnsConsultarNfsePorRpsResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  ConsultarNfseServicoTomado(
    ...
    callback: (
      err: any,
      result: TnsConsultarNfseServicoTomadoResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  RecepcionarLoteRps(
    ...
    callback: (
      err: any,
      result: TnsRecepcionarLoteRpsResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  RecepcionarLoteRpsSincrono(
    ...
    callback: (
      err: any,
      result: TnsRecepcionarLoteRpsSincronoResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  ConsultarNfseServicoPrestado(
    ...
    callback: (
      err: any,
      result: TnsConsultarNfseServicoPrestadoResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  CancelarNfse(
    ...
    callback: (err: any, result: TnsCancelarNfseResponse, rawResponse: any, soapHeader: any, rawRequest: any) => void,
  ): void;
  ...
  ConsultarLoteRps(
    ...
    callback: (
      err: any,
      result: TnsConsultarLoteRpsResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  ConsultarNfseFaixa(
    ...
    callback: (
      err: any,
      result: TnsConsultarNfseFaixaResponse,
      rawResponse: any,
      soapHeader: any,
      rawRequest: any,
    ) => void,
  ...
  GerarNfse(
    ...
    callback: (err: any, result: TnsGerarNfseResponse, rawResponse: any, soapHeader: any, rawRequest: any) => void,
  ): void;

  SubstituirNfse(
    substituirNfse: TnsSubstituirNfse,
    callback: (err: any, result: TnsSubstituirNfseResponse, rawResponse: any, soapHeader: any, rawRequest: any) => void,
  ): void;
}
