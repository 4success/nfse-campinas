...
export interface LoteRpsClient extends SoapClient {
  ...
  consultarSequencialRpsAsync(
    consultarSequencialRpsRequest: ConsultarSequencialRpsRequest,
  ): Promise<[ConsultarSequencialRpsRequest1, string, any, string]>;

  enviarSincronoAsync(
    enviarSincronoRequest: EnviarSincronoRequest,
  ): Promise<[EnviarSincronoRequest1, string, any, string]>;
  ...
  consultarNFSeRpsAsync(
    consultarNfSeRpsRequest: ConsultarNfSeRpsRequest,
  ): Promise<[ConsultarNfSeRpsRequest1, string, any, string]>;
}
